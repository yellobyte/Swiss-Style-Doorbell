...
A while ago I got an Email from a then unknown person asking the innocent question how to control a simple 4-relais board. After digging deeper he revealed his plan to build a rather unusual door-bell for his medium sized home which turned out to be located in a rather small and remote village (less than 100 inhabitants) in the french part of the Jura Mountains.  
...
Based on the above schematic the circuit board was put together with various components I had at hand. Only part I had to order was the voltage suppressor diode which kills possible voltage spikes delivered by 12m wire connecting the board with the bell button.

![github](https://github.com/yellobyte/Swiss-Style-Doorbell/raw/main/doc/Circuit%20Board%20Top.jpg)  

When coding was done as well and the weather forecast didn't issue any warnings we fixed a date for installation. It took place a few days later on a biker proof sunny and dry Saturday. At arrival this sight in his garage was greeting me.
...
After having all electrical wires connected and conducting a first test our ears almost were blewn off. That 3-horn device made a hell of a noise and the melody was somewhat strange too. Since we both lack a musical ear our better halves got asked and they finally uncovered the truth. By mistake we had the valves connected in wrong order. After fixing that detail, handing out earmuffs and playing with the timings in the code finally everybody was happy. The vintage bell button at the frontdoor got wired to the controller and we were ready for the [moment of truth.](https://github.com/yellobyte/Swiss-Style-Doorbell/blob/main/doc/Final%20Test%20with%20Bell%20Button%20connected.mp4)

![github](https://github.com/yellobyte/Swiss-Style-Doorbell/blob/main/doc/Bell%20Button.jpg)
...
...
```
The code uses an interrupt timer to issue the 8 tones so that their timing is constant and accurate.