...
Many Emails and Signal messenger sessions later all necessary informations (e.g. physical distance between bell button, circuit board, horns, the operating voltage of valves, etc.) were gathered and creating a simple schematic was now possible. 
